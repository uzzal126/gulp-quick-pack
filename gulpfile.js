...
gulp.task('allTask', gulp.series(fonts, html, vendorCss, pluginsCss, styleCss, scss, vendorJs, pluginsJs, pluginsRelatedJs, pluginsRelatedJsRoot, mainJs, imageOptimize));
...
function watchFiles() {
    ...
    gulp.watch(src.img, gulp.series(imageOptimize, reload));
}
